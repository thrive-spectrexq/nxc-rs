...
impl NxcModule for DaclRead {
    ...
    fn description(&self) -> &'static str {
        "Read DACLs on AD objects to identify permission misconfigurations"
    }
    ...
    fn options(&self) -> Vec<ModuleOption> {
        vec![
            ModuleOption {
                name: "TARGET_DN".into(),
                description: "DN of target object to read DACLs".into(),
                required: false,
                default: None,
            },
            ModuleOption {
                name: "PRINCIPAL".into(),
                description: "Filter ACEs for this principal".into(),
                required: false,
                default: None,
            },
        ]
    ...
    async fn run(
        ...
        Ok(ModuleResult {
            success: true,
            output,
            data: json!({"target": target, "base_dn": base_dn}),
            credentials: vec![],
        })
    }
}
