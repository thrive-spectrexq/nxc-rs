...
pub struct Ms17010;
impl Ms17010 { pub fn new() -> Self { Self } }
impl Default for Ms17010 { fn default() -> Self { Self::new() } }

#[async_trait]
impl NxcModule for Ms17010 {
    fn name(&self) -> &'static str { "ms17_010" }
    fn description(&self) -> &'static str { "Scan for MS17-010 EternalBlue vulnerability (CVE-2017-0144)" }
    ...
    async fn run(&self, session: &mut dyn NxcSession, _opts: &ModuleOptions) -> Result<ModuleResult> {
        ...
        let negotiate_smb1 = [
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, // SMB header padding
            0x00, // WordCount
            0x62, 0x00, // ByteCount
            ...
            0x2E, 0x30, 0x00, 0x02, 0x57, 0x69, 0x6E, 0x64,
            0x6F, 0x77, 0x73, 0x20, 0x66, 0x6F, 0x72, 0x20,
            0x57, 0x6F, 0x72, 0x6B, 0x67, 0x72, 0x6F, 0x75,
            0x70, 0x73, 0x20, 0x33, 0x2E, 0x31, 0x61, 0x00,
            0x02, 0x4C, 0x4D, 0x31, 0x2E, 0x32, 0x58, 0x30,
            0x30, 0x32, 0x00, 0x02, 0x4C, 0x41, 0x4E, 0x4D,
            0x41, 0x4E, 0x32, 0x2E, 0x31, 0x00, 0x02, 0x4E,
        ...
        match TcpStream::connect(&target_addr).await {
            ...
            Err(e) => {
                output.push_str(&format!("  [-] Connection failed: {}\n", e));
            }
        }
