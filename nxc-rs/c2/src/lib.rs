...
pub trait C2Backend {
    ...
    async fn upload_file(&self, session_id: &str, local_path: &str, remote_path: &str) -> anyhow::Result<()>;
    async fn download_file(&self, session_id: &str, remote_path: &str, local_path: &str) -> anyhow::Result<()>;
}
